...
data.frame(check.names = FALSE, row.names = "mean age",
  "rFSH" = 20.5, "eFSH" = 30.3, "Mixed rFSH+eFSH" = 40.4) |>
  knitr::kable()
```
:::
...
```{r}
#| label: plot-var
#| fig.cap: "Continuous variable (e.g. age) pre- and post-weighting."
#| fig.height: 5
#| fig.width: 10
#| echo: FALSE
p1 <- df |>
  plot_pdf(variable, protocol, fill = TRUE) +
  labs(title = "Unadjusted") +
  guides(fill = "none", color = "none")
p2 <- df |>
  plot_pdf(variable, protocol, fill = TRUE, weight = weights) +
  labs(title = "Adjusted")
p1 + p2
```
