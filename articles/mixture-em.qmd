...
2. **Expectation**: compute _responsibilities_ from posterior
   probabilities, where the responsibilities are the relative
   contribution of distribution 2 (the second mode) in _explaining_
   each data point (this is a _soft_ assignment). Responsibilities of
...
3. **Maximization**: compute _weighted_ maximum likelihood
