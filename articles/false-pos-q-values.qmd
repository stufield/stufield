...
case, any positive findings _must_ be false. For each of the many
...
significant results _by chance_ alone. These are the 5%
...
means that the total distribution of p-values looks
like **Fig. 2** below:
...
determine the p-value cutoff to use -- it does _not_ have to be 5%! It
