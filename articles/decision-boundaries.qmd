...
predict_bivariate_knn <- function(X, y, k, newdata,
                                  method = "minkowski") {
  if ( k < 2L ) {
...
the disease (purple) Feature_1 \> 44 and Feature_2 \> 74, these data
are simulated with an *unrealistic* threshold to form the classes. The
...
#| fig.width: 11
#| fig.height: 5
plot_decision_boundary(sim_data1(), k = 15L)
plot_decision_boundary(sim_data1(), model_type = "bayes")
withr::with_par(
